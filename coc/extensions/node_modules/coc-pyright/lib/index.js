...
var require_range = __commonJS((exports2, module2) => {
  var Range11 = class {
    constructor(range, options) {
      options = parseOptions(options);
      if (range instanceof Range11) {
        if (range.loose === !!options.loose && range.includePrerelease === !!options.includePrerelease) {
          return range;
        } else {
          return new Range11(range.raw, options);
        }
      }
  ...
  var Comparator = class {
    ...
    intersects(comp, options) {
      ...
      if (this.operator === "") {
        ...
        return new Range11(comp.value, options).test(this.value);
      } else if (comp.operator === "") {
        if (comp.value === "") {
          return true;
        }
        return new Range11(this.value, options).test(comp.semver);
      }
...
var require_satisfies = __commonJS((exports2, module2) => {
  ...
  var satisfies = (version, range, options) => {
    try {
      range = new Range11(range, options);
    } catch (er) {
      return false;
    }
...
var require_to_comparators = __commonJS((exports2, module2) => {
  var Range11 = require_range();
  var toComparators = (range, options) => new Range11(range, options).set.map((comp) => comp.map((c) => c.value).join(" ").trim().split(" "));
...
var require_max_satisfying = __commonJS((exports2, module2) => {
  ...
  var maxSatisfying = (versions, range, options) => {
    ...
    let rangeObj = null;
    try {
      rangeObj = new Range11(range, options);
    } catch (er) {
      return null;
    }
    versions.forEach((v) => {
...
var require_valid2 = __commonJS((exports2, module2) => {
  ...
  var validRange = (range, options) => {
    try {
      return new Range11(range, options).range || "*";
    } catch (er) {
      return null;
    }
  };
...
var require_intersects = __commonJS((exports2, module2) => {
  ...
  var intersects = (r1, r2, options) => {
    r1 = new Range11(r1, options);
    r2 = new Range11(r2, options);
  ...
  function patch(fs6) {
    ...
    function patchLchmod(fs7) {
      fs7.lchmod = function(path11, mode, callback) {
        fs7.open(path11, constants.O_WRONLY | constants.O_SYMLINK, mode, function(err, fd) {
          if (err) {
            if (callback)
              callback(err);
            return;
      ...
      fs7.lchmodSync = function(path11, mode) {
        var fd = fs7.openSync(path11, constants.O_WRONLY | constants.O_SYMLINK, mode);
        var threw = true;
        var ret;
        try {
    ...
    function patchLutimes(fs7) {
      if (constants.hasOwnProperty("O_SYMLINK")) {
        fs7.lutimes = function(path11, at, mt, cb) {
          fs7.open(path11, constants.O_SYMLINK, function(er, fd) {
            if (er) {
              if (cb)
                cb(er);
              return;
        ...
        fs7.lutimesSync = function(path11, at, mt) {
          var fd = fs7.openSync(path11, constants.O_SYMLINK);
          var ret;
          var threw = true;
          try {
...
var require_graceful_fs = __commonJS((exports2, module2) => {
  ...
  function patch(fs7) {
    ...
    function readFile(path11, options, cb) {
      ...
      function go$readFile(path12, options2, cb2) {
        return fs$readFile(path12, options2, function(err) {
          if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
            enqueue([go$readFile, [path12, options2, cb2]]);
          else {
    ...
    function writeFile(path11, data, options, cb) {
      ...
      function go$writeFile(path12, data2, options2, cb2) {
        return fs$writeFile(path12, data2, options2, function(err) {
          if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
            enqueue([go$writeFile, [path12, data2, options2, cb2]]);
          else {
            if (typeof cb2 === "function")
              cb2.apply(this, arguments);
            retry();
    ...
    function appendFile(path11, data, options, cb) {
      ...
      function go$appendFile(path12, data2, options2, cb2) {
        return fs$appendFile(path12, data2, options2, function(err) {
          if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
            enqueue([go$appendFile, [path12, data2, options2, cb2]]);
          else {
            if (typeof cb2 === "function")
              cb2.apply(this, arguments);
            retry();
    ...
    function go$readdir(args) {
      return fs$readdir.apply(fs7, args);
    }
    ...
    function open(path11, flags, mode, cb) {
      ...
      function go$open(path12, flags2, mode2, cb2) {
        return fs$open(path12, flags2, mode2, function(err, fd) {
          if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
            enqueue([go$open, [path12, flags2, mode2, cb2]]);
          else {
            if (typeof cb2 === "function")
              cb2.apply(this, arguments);
            retry();
...
var require_make_dir = __commonJS((exports2, module2) => {
  ...
  module2.exports.makeDir = async (input, options) => {
    ...
    if (useNativeRecursiveOption) {
      const pth = path11.resolve(input);
    ...
    const make = async (pth) => {
      try {
        await fs6.mkdir(pth, options.mode);
      } catch (error) {
        if (error.code === "EPERM") {
          throw error;
        }
        if (error.code === "ENOENT") {
          if (path11.dirname(pth) === pth) {
            throw permissionError(pth);
          }
          if (error.message.includes("null bytes")) {
            throw error;
          }
          await make(path11.dirname(pth));
          return make(pth);
        }
        try {
          const stats = await fs6.stat(pth);
  ...
  module2.exports.makeDirSync = (input, options) => {
    ...
    const make = (pth) => {
      try {
        fs6.mkdirSync(pth, options.mode);
      } catch (error) {
        if (error.code === "EPERM") {
          throw error;
        }
        ...
        try {
          if (!fs6.statSync(pth).isDirectory()) {
            throw new Error("The path is not a directory");
          }
        } catch {
          throw error;
...
var require_utimes = __commonJS((exports2, module2) => {
  ...
  function utimesMillisSync(path11, atime, mtime) {
    const fd = fs6.openSync(path11, "r+");
...
var require_stat = __commonJS((exports2, module2) => {
  ...
  var statSync = (file) => nodeSupportsBigInt ? fs6.statSync(file, {bigint: true}) : fs6.statSync(file);
  ...
  function checkParentPaths(src, srcStat, dest, funcName, cb) {
    ...
    if (nodeSupportsBigInt)
      fs6.stat(destParent, {bigint: true}, callback);
    else
      fs6.stat(destParent, callback);
  }
...
var require_path_exists = __commonJS((exports2, module2) => {
  ...
  function pathExists(path11) {
    return fs6.access(path11).then(() => true).catch(() => false);
  }
  module2.exports = {
...
var require_windows = __commonJS((exports2, module2) => {
  ...
  function isexe(path11, options, cb) {
    fs6.stat(path11, function(er, stat) {
      cb(er, er ? false : checkStat(stat, path11, options));
    });
  }
  function sync(path11, options) {
    return checkStat(fs6.statSync(path11), path11, options);
  }
});
...
var require_mode = __commonJS((exports2, module2) => {
  ...
  function sync(path11, options) {
    return checkStat(fs6.statSync(path11), options);
  }
...
var require_diff_match_patch = __commonJS((exports2, module2) => {
...
var require_root = __commonJS((exports2) => {
  "use strict";
...
var require_isArray = __commonJS((exports2) => {
  "use strict";
  exports2.isArray = Array.isArray || function(x) {
...
var require_errorObject = __commonJS((exports2) => {
  "use strict";
  exports2.errorObject = {e: {}};
});

// node_modules/rxjs/util/tryCatch.js
var require_tryCatch = __commonJS((exports2) => {
  "use strict";
...
var require_rxSubscriber = __commonJS((exports2) => {
  ...
  exports2.rxSubscriber = typeof Symbol2 === "function" && typeof Symbol2.for === "function" ? Symbol2.for("rxSubscriber") : "@@rxSubscriber";
...
var require_observable = __commonJS((exports2) => {
  ...
  exports2.getSymbolObservable = getSymbolObservable;
  exports2.observable = getSymbolObservable(root_1.root);
  exports2.$$observable = exports2.observable;
});
...
var require_tree_kill = __commonJS((exports2, module2) => {
  "use strict";
...
var require_named_js_regexp = __commonJS((exports2, module2) => {
  "use strict";
  (function(window10) {
...
var PythonCodeActionProvider = class {
  ...
  provideCodeActions(document, range) {
    ...
    const actions = [];
    const config = import_coc.workspace.getConfiguration("pyright");
    const provider = config.get("organizeimports.provider", "pyright");
    if (provider === "pyright") {
      actions.push({
        title: "Organize Imports by Pyright",
        kind: import_coc.CodeActionKind.SourceOrganizeImports,
        command: {
          title: "",
    ...
    if (this.wholeRange(doc, range)) {
      let pos = import_coc.Position.create(0, 0);
      if (doc.getline(0).startsWith("#!")) {
        pos = import_coc.Position.create(1, 0);
      }
      const edit = import_coc.TextEdit.insert(pos, "# type: ignore\n");
      actions.push({
    ...
    if (range.start.line === range.end.line && range.start.character === 0) {
      ...
      if (!line.startsWith("#") && line.length === range.end.character) {
        const edit = import_coc.TextEdit.replace(range, line + " # type: ignore");
        actions.push({
    ...
    if (!this.wholeRange(doc, range)) {
      actions.push({
        ...
        kind: import_coc.CodeActionKind.RefactorExtract,
        command: {
...
var PythonSettings2 = class {
  ...
  static getInstance() {
    ...
    if (!PythonSettings2.pythonSettings.has(workspaceFolderKey)) {
      const settings = new PythonSettings2();
      PythonSettings2.pythonSettings.set(workspaceFolderKey, settings);
    }
    return PythonSettings2.pythonSettings.get(workspaceFolderKey);
  }
  static dispose() {
    PythonSettings2.pythonSettings.forEach((item) => item && item.dispose());
    PythonSettings2.pythonSettings.clear();
  }
  dispose() {
    ...
    try {
      ...
      if (import_fs_extra.default.existsSync(p)) {
        if (!process.env.PYENV_VERSION) {
          process.env.PYENV_VERSION = import_fs_extra.default.readFileSync(p).toString().trim();
        }
        return;
      }
      p = import_path.default.join(this.workspaceRoot, "Pipfile");
      if (import_fs_extra.default.existsSync(p)) {
        return child_process.execFileSync("pipenv", ["--py"], {encoding: "utf8"}).toString().trim();
      }
      p = import_path.default.join(this.workspaceRoot, "poetry.lock");
      if (import_fs_extra.default.existsSync(p)) {
  ...
  update(pythonSettings) {
    ...
    if (vp) {
      ...
      this.pythonPath = systemVariables.resolve(pythonSettings.get("pythonPath"));
    }
  ...
  getAbsolutePath(pathToCheck, rootDir) {
    ...
    pathToCheck = import_untildify.default(pathToCheck);
    if (pathToCheck.indexOf(import_path.default.sep) === -1) {
      return pathToCheck;
    }
    return import_path.default.isAbsolute(pathToCheck) ? pathToCheck : import_path.default.resolve(rootDir, pathToCheck);
  }
  initialize() {
    this.disposables.push(import_coc2.workspace.onDidChangeConfiguration((event) => {
...
var PythonSettings = PythonSettings2;
PythonSettings.pythonSettings = new Map();
function getPythonExecutable(pythonPath) {
  pythonPath = import_untildify.default(pythonPath);
...
var Edit = class {
  ...
  apply() {
    switch (this.action) {
      ...
      default:
        return {
          range: import_coc3.Range.create(0, 0, 0, 0),
          newText: ""
        };
    }
  }
...
function getWindowsLineEndingCount(document, offset) {
  ...
  for (let pos = 0; pos < offset; pos += readBlock) {
    ...
    const text = document.getText(import_coc3.Range.create(startAt, endAt));
...
var import_Observable = __toModule(require_Observable());
...
var ProcessService = class {
  ...
  execObservable(file, args, options = {}) {
    ...
    const proc = import_child_process.spawn(file, args, spawnOptions);
    let procExited = false;
    const output = new import_Observable.Observable((subscriber) => {
      if (options.token) {
  ...
  exec(file, args, options = {}) {
    if (file.startsWith("~/")) {
      file = file.replace("~", import_os2.homedir());
    }
    const spawnOptions = this.getDefaultOptions(options);
...
function getTempFileWithDocumentContents(document) {
  return new Promise((resolve, reject) => {
    const fsPath = import_coc4.Uri.parse(document.uri).fsPath;
    const ext = import_path2.default.extname(fsPath);
    const fileName = `${fsPath}.${import_md5.default(document.uri)}${ext}`;
    import_fs_extra2.default.writeFile(fileName, document.getText(), (ex) => {
      if (ex) {
...
var BaseFormatter = class {
  ...
  getDocumentPath(document, fallbackPath) {
    ...
    if (fallbackPath && import_path2.default.basename(filepath) === filepath) {
      return fallbackPath;
    }
  ...
  getWorkspaceUri(document) {
    const filepath = import_coc4.Uri.parse(document.uri).fsPath;
    if (!filepath.startsWith(import_coc4.workspace.root))
      return;
    return import_coc4.Uri.file(import_coc4.workspace.root);
  }
  getExecutionInfo(args) {
    let moduleName;
    const execPath = this.pythonSettings.formatting[`${this.Id}Path`];
    if (import_path2.default.basename(execPath) === execPath) {
      moduleName = execPath;
    }
  ...
  async provideDocumentFormattingEdits(document, _options, token, args, cwd) {
    if (typeof cwd !== "string" || cwd.length === 0) {
      cwd = import_coc4.Uri.file(import_coc4.workspace.root).fsPath;
    }
    const filepath = import_coc4.Uri.parse(document.uri).fsPath;
    ...
    const promise = pythonToolsExecutionService.exec(executionInfo, {cwd, throwOnStdErr: false, token}).then((output) => output.stdout).then((data) => {
    ...
    promise.then(() => {
      ...
      setTimeout(async () => {
        const line = await nvim.call("coc#util#echo_line");
  ...
  deleteTempFile(originalFile, tempFile) {
    if (originalFile !== tempFile) {
      return import_util.promisify(import_fs_extra2.default.unlink)(tempFile);
    }
...
var DarkerFormatter = class extends BaseFormatter {
  ...
  createTempFile(document) {
    return new Promise((resolve) => {
      resolve(import_coc6.Uri.parse(document.uri).fsPath);
    });
  }
...
var BlackdFormatter = class extends BaseFormatter {
  constructor(pythonSettings, outputChannel) {
    ...
    if (!this.blackdHTTPURL.length) {
      ...
      this.blackdServer = import_child_process2.spawn(blackdPath).on("error", (e) => {
        this.outputChannel.appendLine("");
  ...
  async handle(document) {
    try {
      ...
      const patch = await import_coc7.fetch(_url, {method: "POST", data: document.getText(), headers});
      this.outputChannel.appendLine("");
      this.outputChannel.appendLine(`${"#".repeat(10)} ${this.Id} output:`);
...
async function generateIsortFixDiff(extensionRoot, uri) {
  ...
  if (typeof isortPath === "string" && isortPath.length > 0) {
    ...
    const importScript = path3.join(extensionRoot, "pythonFiles", "sortImports.py");
...
async function sortImports(extensionRoot, outputChannel) {
  ...
  const uri = import_coc9.Uri.parse(doc.uri);
  if (doc.lineCount <= 1) {
    return;
  }
  try {
...
// src/linters/errorHandlers/baseErrorHandler.ts
var BaseErrorHandler = class {
  constructor(product, outputChannel) {
...
// src/linters/errorHandlers/notInstalled.ts
var NotInstalledErrorHandler = class extends BaseErrorHandler {
  constructor(product, outputChannel) {
    super(product, outputChannel);
  }
  async handleError(error, _resource, _execInfo) {
...
// src/linters/errorHandlers/standard.ts
var StandardErrorHandler = class extends BaseErrorHandler {
  constructor(product, outputChannel) {
    super(product, outputChannel);
  }
...
// src/linters/errorHandlers/errorHandler.ts
...
function matchNamedRegEx(data, regex) {
  const compiledRegexp = import_named_js_regexp.default(regex, "g");
...
var BaseLinter = class {
  ...
  async run(args, document, cancellation, regEx = REGEX) {
    ...
    const executionInfo = this.info.getExecutionInfo(args, import_coc10.Uri.parse(document.uri));
    try {
      const pythonToolsExecutionService = new PythonExecutionService();
      const result = await pythonToolsExecutionService.exec(executionInfo, {cwd: import_coc10.workspace.root, token: cancellation, mergeStdOutErr: false});
...
`);
      ...
      await this.errorHandler.handleError(error, import_coc10.Uri.parse(document.uri), executionInfo).catch(() => {
      });
      return [];
    }
  }
...
var Bandit = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["-f", "custom", "--msg-template", "{line},0,{severity},{test_id}:{msg}", "-n", "-1", import_coc11.Uri.parse(document.uri).fsPath], document, cancellation);
...
var Flake8 = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["--format=%(row)d,%(col)d,%(code).1s,%(code)s:%(text)s", import_coc12.Uri.parse(document.uri).fsPath], document, cancellation);
    messages.forEach((msg) => {
...
var LinterInfo = class {
  ...
  getExecutionInfo(customArgs, resource) {
    ...
    let moduleName;
    if (path4.basename(execPath) === execPath) {
      moduleName = execPath;
    }
...
var MyPy = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run([import_coc13.Uri.parse(document.uri).fsPath], document, cancellation, REGEX2);
    messages.forEach((msg) => {
...
var Pep8 = class extends BaseLinter {
  constructor(info, outputChannel) {
    super(info, outputChannel, COLUMN_OFF_SET3);
  }
  async runLinter(document, cancellation) {
    const messages = await this.run(["--format=%(row)d,%(col)d,%(code).1s,%(code)s:%(text)s", import_coc14.Uri.parse(document.uri).fsPath], document, cancellation);
    messages.forEach((msg) => {
...
var Prospector = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const relativePath = import_path3.default.relative(import_coc15.workspace.root, import_coc15.Uri.parse(document.uri).fsPath);
...
var PyDocStyle = class extends BaseLinter {
  ...
  async parseMessages(output, document, _token, _regEx) {
    ...
    const baseFileName = path6.basename(import_coc16.Uri.parse(document.uri).fsPath);
    ...
    const doc = import_coc16.workspace.getDocument(document.uri);
...
var dotPylintrc = ".pylintrc";
var REGEX4 = "(?<line>\\d+),(?<column>-?\\d+),(?<type>\\w+),(?<code>[^:]+):(?<message>.*)\\r?(\\n|$)";
var Pylint = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    ...
    if (settings.linting.pylintUseMinimalCheckers && this.info.linterArgs(uri).length === 0 && !await this.hasConfigrationFileInWorkspace(path7.dirname(uri.fsPath), import_coc18.workspace.root) && !await this.hasConfigurationFile(import_coc18.workspace.root)) {
      minArgs = [
        "--disable=all",
    ...
    const messages = await this.run(minArgs.concat(args), document, cancellation, REGEX4);
    messages.forEach((msg) => {
  ...
  async hasConfigurationFile(folder) {
    ...
    if (await import_fs_extra3.default.pathExists(path7.join(folder, pylintrc)) || await import_fs_extra3.default.pathExists(path7.join(folder, dotPylintrc))) {
      return true;
    }
    let current = folder;
    let above = path7.dirname(folder);
    do {
      if (!await import_fs_extra3.default.pathExists(path7.join(current, "__init__.py"))) {
        break;
      }
      if (await import_fs_extra3.default.pathExists(path7.join(current, pylintrc)) || await import_fs_extra3.default.pathExists(path7.join(current, dotPylintrc))) {
        return true;
      }
      current = above;
      above = path7.dirname(above);
    } while (!this.arePathsSame(current, above));
    const home = os.homedir();
    if (await import_fs_extra3.default.pathExists(path7.join(home, dotPylintrc))) {
      return true;
    }
    if (await import_fs_extra3.default.pathExists(path7.join(home, ".config", pylintrc))) {
      return true;
    }
    if (!this.isWindows) {
      if (await import_fs_extra3.default.pathExists(path7.join("/etc", pylintrc))) {
        return true;
      }
    }
    return false;
  }
  arePathsSame(path1, path22) {
    path1 = path7.normalize(path1);
    path22 = path7.normalize(path22);
    if (this.isWindows) {
  ...
  async hasConfigrationFileInWorkspace(folder, root) {
    let current = folder;
    let above = path7.dirname(current);
    do {
      if (await import_fs_extra3.default.pathExists(path7.join(current, pylintrc)) || await import_fs_extra3.default.pathExists(path7.join(current, dotPylintrc))) {
        return true;
      }
...
var Pytype = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const args = [];
    if (await this.hasConfigurationFile(import_coc19.workspace.root)) {
      args.push(...["--config", pytypecfg]);
    }
    args.push(import_coc19.Uri.parse(document.uri).fsPath);
    return await this.run(args, document, cancellation, REGEX5);
  }
  async parseMessages(output, document, token, regEx) {
    ...
    const messages = (await super.parseMessages(newOutput, document, token, regEx)).filter((msg) => {
      return msg.file && msg.file === import_coc19.Uri.parse(document.uri).fsPath;
    });
  ...
  async hasConfigurationFile(folder) {
    if (await import_fs_extra4.default.pathExists(path8.join(folder, pytypecfg))) {
      return true;
    }
    let current = folder;
    let above = path8.dirname(folder);
    do {
      if (!await import_fs_extra4.default.pathExists(path8.join(current, "__init__.py"))) {
        break;
      }
      if (await import_fs_extra4.default.pathExists(path8.join(current, pytypecfg))) {
        return true;
      }
      current = above;
      above = path8.dirname(above);
    } while (!this.arePathsSame(current, above));
    return false;
  }
  arePathsSame(path1, path22) {
    path1 = path8.normalize(path1);
    path22 = path8.normalize(path22);
    if (this.isWindows) {
      return path1.toUpperCase() === path22.toUpperCase();
    } else {
      return path1 === path22;
...
var LintingEngine = class {
  ...
  async lintOpenPythonFiles() {
    ...
    const promises = import_coc20.workspace.textDocuments.map(async (document) => this.lintDocument(document));
  ...
  async lintDocument(document) {
    ...
    const fsPath = import_coc20.Uri.parse(document.uri).fsPath;
    if (this.pendingLintings.has(fsPath)) {
      this.pendingLintings.get(fsPath).cancel();
      this.pendingLintings.delete(fsPath);
    }
    const cancelToken = new import_coc20.CancellationTokenSource();
    ...
    const activeLinters = await this.getActiveLinters(import_coc20.Uri.parse(document.uri));
    ...
    for (const p of promises) {
      ...
      const doc = import_coc20.workspace.getDocument(document.uri);
      if (doc) {
        for (const m of msgs) {
  ...
  createDiagnostics(message, _document) {
    const position = import_coc20.Position.create(message.line - 1, message.column);
    const range = import_coc20.Range.create(position, position);
    const severity = lintSeverityToVSSeverity.get(message.severity);
    const diagnostic = import_coc20.Diagnostic.create(range, message.message, severity);
  ...
  shouldLintDocument(document) {
    ...
    const relativeFileName = import_path4.default.relative(import_coc20.workspace.root, import_coc20.Uri.parse(document.uri).fsPath);
    const ignoreMinmatches = settings.linting.ignorePatterns.map((pattern) => new import_minimatch.Minimatch(pattern, {dot: true}));
    if (ignoreMinmatches.some((matcher) => matcher.match(import_coc20.Uri.parse(document.uri).fsPath) || matcher.match(relativeFileName))) {
      this.outputChannel.appendLine(`${"#".repeat(5)} linting is ignored by python.linting.ignorePatterns`);
      return false;
    }
    const u = import_coc20.Uri.parse(document.uri);
...
var LinterProvider = class {
  constructor(context) {
    ...
    import_coc21.workspace.onDidOpenTextDocument((e) => this.onDocumentOpened(e), this.context.subscriptions);
    import_coc21.workspace.onDidCloseTextDocument((e) => this.onDocumentClosed(e), this.context.subscriptions);
    import_coc21.workspace.onDidSaveTextDocument((e) => this.onDocumentSaved(e), this.context.subscriptions);
    const disposable = import_coc21.workspace.onDidChangeConfiguration(this.lintSettingsChangedHandler.bind(this));
    this.disposables.push(disposable);
    this.disposables.push(import_coc21.commands.registerCommand("python.runLinting", this.runLinting.bind(this)));
  ...
  lintSettingsChangedHandler(e) {
    import_coc21.workspace.textDocuments.forEach((document) => {
  ...
  onDocumentClosed(document) {
    if (!document || !import_coc21.Uri.parse(document.uri).fsPath || !document.uri) {
      return;
    }
...
var path10 = __toModule(require("path"));
var RefactorProxy = class {
  ...
  async extractVariable(document, name, filePath, range) {
    const options = await import_coc22.workspace.getFormatOptions();
    const command = {
  ...
  async initialize() {
    ...
    const cwd = path10.join(this._extensionDir, "pythonFiles");
...
function validateDocumentForRefactor(doc) {
  ...
  return new Promise((resolve, reject) => {
    import_coc23.workspace.nvim.command("write").then(() => {
      return resolve();
    }, reject);
  });
}
async function extractVariable(extensionDir, document, range, outputChannel) {
  ...
  const workspaceRoot = workspaceFolder ? import_coc23.Uri.parse(workspaceFolder.uri).fsPath : import_coc23.workspace.cwd;
  const pythonSettings = PythonSettings.getInstance();
  return validateDocumentForRefactor(doc).then(() => {
    ...
    const rename = proxy.extractVariable(doc.textDocument, newName, import_coc23.Uri.parse(doc.uri).fsPath, range).then((response) => {
      return response.results[0].diff;
    });
    return extractName(doc, newName, rename, outputChannel);
  });
}
async function extractMethod(extensionDir, document, range, outputChannel) {
  const doc = import_coc23.workspace.getDocument(document.uri);
  const valid = await checkDocument(doc);
  if (!valid)
    return;
  ...
  return validateDocumentForRefactor(doc).then(() => {
    ...
    const proxy = new RefactorProxy(extensionDir, pythonSettings, workspaceRoot);
    const rename = proxy.extractMethod(doc.textDocument, newName, import_coc23.Uri.parse(doc.uri).fsPath, range).then((response) => {
      return response.results[0].diff;
    });
    return extractName(doc, newName, rename, outputChannel);
  });
}
async function extractName(textEditor, newName, renameResponse, outputChannel) {
  ...
  try {
    ...
    if (changeStartsAtLine >= 0) {
      ...
      for (let lineNumber = changeStartsAtLine; lineNumber < textEditor.lineCount; lineNumber += 1) {
        ...
        if (indexOfWord >= 0) {
          newWordPosition = import_coc23.Position.create(lineNumber, indexOfWord);
          break;
        }
      }
      return import_coc23.workspace.jumpTo(textEditor.uri, newWordPosition).then(() => {
        return newWordPosition;
      });
    }
    const newWordPosition_1 = null;
    if (newWordPosition_1) {
      return import_coc23.workspace.nvim.command("wa").then(() => {
        return import_coc23.commands.executeCommand("editor.action.rename", textEditor.uri, newWordPosition_1);
      });
    }
  } catch (error) {
...
// src/index.ts
var documentSelector = [{scheme: "file", language: "python"}];
...
async function provideDefinition(document, position, token, next) {
  ...
  if (import_coc24.Location.is(locations))
    return locations;
  let pyiFirst = false;
  if (Array.isArray(locations) && locations.length > 1) {
    const first = locations[0];
    const uri = import_coc24.Location.is(first) ? first.uri : first.targetUri;
  ...
  if (snippetSupport) {
    ...
    for (const item of items) {
      if ((_a = item.data) == null ? void 0 : _a.funcParensDisabled)
        continue;
      if (item.kind === import_coc24.CompletionItemKind.Method || item.kind === import_coc24.CompletionItemKind.Function) {
        item.insertText = `${item.label}($1)$0`;
        item.insertTextFormat = import_coc24.InsertTextFormat.Snippet;
      }
    }
  }
  return result;
...
async function activate(context) {
  ...
  if (import_semver2.lt(process.versions.node, "12.0.0")) {
    import_coc24.window.showMessage(`Pyright needs Node.js v12+ to work, your Node.js is ${process.version}.`, "error");
    return;
  }
  const module2 = context.asAbsolutePath("node_modules/pyright/langserver.index.js");
  if (!import_fs.existsSync(module2)) {
  ...
  const client = new import_coc24.LanguageClient("pyright", "Pyright Server", serverOptions, clientOptions);
  client.registerFeature(new PyrightExtensionFeature());
  context.subscriptions.push(import_coc24.services.registLanguageClient(client));
  const formatProvider = new PythonFormattingEditProvider();
  context.subscriptions.push(import_coc24.languages.registerDocumentFormatProvider(documentSelector, formatProvider));
  context.subscriptions.push(import_coc24.languages.registerDocumentRangeFormatProvider(documentSelector, formatProvider));
  ...
  textEditorCommands.forEach((commandName) => {
    context.subscriptions.push(import_coc24.commands.registerCommand(commandName, async (offset) => {
      ...
      await import_coc24.workspace.applyEdit(wsEdit);
    }));
  });
  const genericCommands = ["pyright.createtypestub"];
  genericCommands.forEach((command) => {
    context.subscriptions.push(import_coc24.commands.registerCommand(command, async (...args) => {
      const root = import_coc24.workspace.root;
      const module3 = args.pop();
      if (!module3) {
      ...
      const cmd = {
        command,
        arguments: [root, module3]
      };
      client.sendRequest("workspace/executeCommand", cmd);
    }));
  });
  let disposable = import_coc24.commands.registerCommand("python.refactorExtractVariable", async (document, range) => {
    await extractVariable(context.extensionPath, document, range, outputChannel).catch(() => {
    });
  }, null, true);
  context.subscriptions.push(disposable);
  disposable = import_coc24.commands.registerCommand("python.refactorExtractMethod", async (document, range) => {
